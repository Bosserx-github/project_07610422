...
import 'package:project_07610422/pages/search/list.dart';
                ...
                children: [
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              hintText: 'ป้อนจังหวัดที่ต้องการค้นหา เช่น กรุงเทพ , กระบี่ , ภูเก็ต',
                  ...
                  Container(
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          title: Text('สถานที่ท่องเที่ยว', style: GoogleFonts.prompt(fontSize: 20.0),),
                          leading: Radio(
                            value: 1,
                            groupValue: _Select,
                            onChanged: (value) {
                        ...
                        ListTile(
                          title: Text('ที่พัก', style: GoogleFonts.prompt(fontSize: 20.0),
                          ),
                          leading: Radio(
                            value: 2,
                            groupValue: _Select,
                        ...
                        ListTile(
                          title: Text('ร้านอาหาร', style: GoogleFonts.prompt(fontSize: 20.0),
                          ),
                          leading: Radio(
                            value: 3,
                            groupValue: _Select,
                        ...
                        ListTile(
                          title: Text('ร้านค้า', style: GoogleFonts.prompt(fontSize: 20.0),
                          ),
                          leading: Radio(
                            value: 4,
                            groupValue: _Select,
                        ...
                        ListTile(
                          title: Text('อื่นๆ', style: GoogleFonts.prompt(fontSize: 20.0),
                          ),
                          leading: Radio(
                            value: 5,
                            groupValue: _Select,
